<template>
  <div class="app-container calendar-list-container">
    ...
    <div class="filter-container">
      <el-input clearable class="filter-item" style="width: 200px;" @keyup.enter.native="handleFilter" placeholder="请输入商品编号" v-model="listQuery.goodsSn">
      </el-input>
      <el-input clearable class="filter-item" style="width: 200px;" @keyup.enter.native="handleFilter" placeholder="请输入商品名称" v-model="listQuery.name">
      </el-input>
      ...
      <el-table-column align="center" label="详情" prop="detail">
        <template slot-scope="scope">
          <el-dialog title="商品详情" :visible.sync="detailDialogVisible">
            <div class="goodsDetail" v-html="goodsDetail"></div>
          </el-dialog>
